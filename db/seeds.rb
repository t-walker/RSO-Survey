...
Question.create([
  {id: 1, question: 'Play a board game or go biking?', order: 3},
  {id: 2, question: 'Painting or gaming?', order: 1},
  {id: 3, question: 'Knit something or write an algorithm?', order: 1},
  {id: 4, question: 'Go out or stay in?', order: 1},
  {id: 5, question: 'Nude bike ride to raise awareness or write a novel?', order: 1},
  {id: 6, question: 'Dancing or walking on the beach?', order: 1},
  {id: 7, question: 'Watching a movie or making your own?', order: 1},
  {id: 8, question: 'Learn martial arts or how to quilt?', order: 1},
  {id: 9, question: 'Discuss religion or politics?', order: 1},
  {id: 10, question: 'Learn another language or work in a laboratory?', order: 1},
  {id: 11, question: 'Design and create a robot or bake a cake?', order: 1},
  {id: 12, question: 'Play a board game or go target shooting?', order: 1},
  {id: 13, question: 'Raise awareness about the environment or have a debate?', order: 1},
  {id: 14, question: 'Tend a garden or play an online game?', order: 1},
  {id: 15, question: 'Theorize about physics or have a nerf war?', order: 1},
  {id: 16, question: 'Rock climb or play music?', order: 1},
  {id: 17, question: 'Study rocks or learn to shoot a bow?', order: 1},
  {id: 18, question: 'Produce music or discuss current events?', order: 1},
  {id: 19, question: 'Try a new food or watch a new movie?', order: 1}
  #{id: 20, question: ''},
  #{id: 21, question: ''},
  #{id: 22, question: ''},
  #{id: 23, question: ''},
